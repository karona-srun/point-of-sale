 ...
 * ======================================================================== */
 ...
 +function ($) {
	...
	Toggle.DEFAULTS = {
		on: '<img src="image/en.png" style="width:35px; height:25px" alt="English">',
		off: '<img src="image/kh.png" style="width:35px; height:25px" alt="Khmer">',
		onstyle: 'primary',
		offstyle: 'primary',
		size: 'normal',
		style: ''
	...
	Toggle.prototype.defaults = function() {
		return {
			...
			off: this.$element.attr('data-on') || Toggle.DEFAULTS.off,
