...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            <form action="{{ URL::to('manage_item/store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
              {{ csrf_field() }}
              <div class="box-body">
                 <!-- Item Code  -->
                ...
                <div class="form-group">                
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="sell_price" id="inputEmail3" placeholder="{{ __('item.selling_price')}}">
                  </div>
                </div>
                <!-- / Selling Price -->
                <!-- Discount -->
