    ...
    <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa  fa-edit"></i> {{ __('category.button_edit_category')}}
            </div>
            <form action="{{ url('manage_category/update/'.$category->category_id)}}" method="post" class="form-horizontal">
            <input type = "hidden" name = "_token" value = "{{ csrf_token() }}"> 
              <div class="box-body">
                 ...
                 <div class="form-group">                
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="category" id="input_category" value="{{ $category->category }}" placeholder="{{ __('category.category')}}">
                  </div>
                </div>
                <!-- / category -->                              
              </div>
