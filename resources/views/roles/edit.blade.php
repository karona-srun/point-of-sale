        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
              <form action="{{ URL::to('role/update/'.$role->role_id) }}" method="post" class="form-horizontal">
              {{ csrf_field() }}
                <div class="box-body">
                  <!-- Role  -->
                  <div class="form-group">                
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="role_name" id="inputEmail3" placeholder="{{ __('role.role_name')}}" require="" value="{{ $role->role_name}}">
                    </div>
                  </div>
                  <!-- / Role -->                         
                </div>
