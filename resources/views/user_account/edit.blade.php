    ...
    <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa  fa-edit"></i> {{ __('store.button_edit_store')}}
            </div>
            <form class="form-horizontal" action="{{ URL::to('store/update',$store->store_id) }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
              <div class="box-body">
                 <!-- Store Code  -->
                 <div class="form-group">                
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="store_code" placeholder="{{ __('store.store_code')}}" value="{{ $store->store_code}}">
                  </div>
                </div>
                <!-- / Store Code -->
                <!-- Store  -->
                <div class="form-group">                
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="store_name"placeholder="{{ __('store.store')}}" value="{{ $store->store_name}}">
                  </div>
                </div>
                <!-- / Store -->
                <!-- Telephone  -->
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="store_telephone"  placeholder="{{ __('store.telephone')}}"  value="{{ $store->telephone}}">
                  </div>
                </div> 
                <!-- / Telephone  -->
                <!-- Email  -->
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="email" class="form-control" name="store_email"  placeholder="{{ __('store.email')}}"  value="{{ $store->email}}">
                  </div>
                </div> 
                <!-- / Email  -->
                <!-- Address  -->
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea class="form-control" rows="3" name="store_address" placeholder="{{ __('store.address')}}">{{ $store->address}}</textarea>
                  </div>
                </div> 
                <!-- / Address  -->  
                <!-- Logo  -->
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <img src="{{route('store_avatars',$store->store_logo)}}" id="image-tag" name="avatar" width="130px" height="150px" />                   
